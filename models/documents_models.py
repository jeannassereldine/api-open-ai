...
class LetterOfCredit(BaseModel):
    ...
    issue_date: Annotated[date, Field(description="LC issue date")]
    expiry_date: Annotated[date, Field(description="LC expiry date, exemple: 2023-12-31")]
    ...
    latest_shipment_date: Optional[Annotated[date, Field(description="Latest shipment date")]]
...
class BillOfLading(BaseModel):
    ...
    issue_date: Annotated[date, Field(description="Issue date")]
...
class CertificateOfOrigin(BaseModel):
    ...
    issue_date: Annotated[date, Field(description="Date of issue")]
    exporter_name: Annotated[str, Field(description="Exporter name")]
    exporter_address: Annotated[str, Field(description="Exporter address")]
    consignee_name: Annotated[str, Field(description="Consignee name")]
    consignee_address: Annotated[str, Field(description="Consignee address")]
